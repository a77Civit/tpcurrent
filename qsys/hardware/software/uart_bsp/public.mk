...
SOPCINFO_FILE := E:/FPGAProgramm/tpcurrent/qsys/hardware/niios_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is niios_qsys
SOPC_NAME := niios_qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11008
SOPC_SYSID_FLAG += --sidp=0x11008
ELF_PATCH_FLAG  += --sidp 0x11008

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1579320030
SOPC_SYSID_FLAG += --timestamp=1579320030
ELF_PATCH_FLAG  += --timestamp 1579320030
